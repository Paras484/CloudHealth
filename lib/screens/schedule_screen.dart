                  ...
                  children: [
                    InkWell(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: _buttonIndex == 0 ? Colors.red : Colors.transparent,
                          borderRadius: BorderRadius.circular(10),
                        ),
                        child: Text("Upcoming",
                          style: TextStyle(
                    ...
                    InkWell(
                      ...
                      child: Container(
                        padding: EdgeInsets.symmetric(vertical: 12, horizontal: 18),
                        decoration: BoxDecoration(
                          color: _buttonIndex == 1 ? Colors.red : Colors.transparent,
                          borderRadius: BorderRadius.circular(10),
                        ),
                    ...
                    InkWell(
                      ...
                      child: Container(
                        padding: EdgeInsets.symmetric(vertical: 12, horizontal: 18),
                        decoration: BoxDecoration(
                          color: _buttonIndex == 2 ? Colors.red : Colors.transparent,
                          borderRadius: BorderRadius.circular(10),
                        ),
                        child: Text("Canceled",
                          style: TextStyle(
